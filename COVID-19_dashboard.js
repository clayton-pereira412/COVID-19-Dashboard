Highcharts.ajax({
  //s@v7.0.0/samples/data/world-population-history.csv',
  url: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQsF6bcbWwEiOBUNRI93pkpHx_Dif7bGgoz15MY9MZD-HgjsZlTP7DSix-DZ-LZ8fyhF3e2sSlrFrKQ/pub?output=csv',
  dataType: 'csv',
  success: function(csv) {
    ...
    Highcharts.wrap(Highcharts.Point.prototype, 'select', function(proceed) {
      ...
      if (points.length) {
        ...
        document.querySelector('#info .subheader')
          .innerHTML = '<h4>Historical COVID-19 Cases</h4><small><em>Shift + Click on map to compare countries</em></small>';
    ...
    mapChart = Highcharts.mapChart('container', {
      ...
      title: {
        text: 'COVID-19 Case history by country'
      },

      subtitle: {
        text: 'Source: <a href="http://data.worldbank.org/indicator/SP.POP.TOTL/countries/1W?display=default">PwC Dataset</a>'
      },
